  ...
  return (
    <Link to={routes.postdetailed({ id })} className="w-full flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      ...
      <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 style={{overflowWrap: "anywhere"}} className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{title}</h5>
        <p style={{overflowWrap: "anywhere"}} className="mb-3 font-normal text-gray-700 dark:text-gray-400">{bodyTruncated}</p>
